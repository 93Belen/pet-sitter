...
const [show, setShow] = useState(false)
  ...
  const handlePriceChange = (event) => {
    ...
    return (
      ...
      <div className='absolute bg-mygray w-3/6 h-screen top-0 right-0 flex flex-col justify-around p-10'>
        ...
        <button onClick={() => {editPricing(1)}} className='bg-mytheme py-3 px-6 rounded-full w-fit'>Update!</button>
      </div>
       <div className='p-6 bg-mygray rounded-lg flex flex-col gap-5'>
         ...
         <p>Lorem ipsum dolor sit amet consectetur 
          ...
          <button className='bg-mytheme py-3 px-6 rounded-full w-fit m-auto'>Edit</button>
       </div>
       <div className='p-6 bg-mygray rounded-lg flex flex-col gap-5'>
